...
function CreateToDoItems() {
  ...
  function ReadToDoItems() {
    todo.forEach((element) => {
      ...
      ${
        style === ""
          ? ""
          : '<img class="todo-controls" src="/image/pngwing.com.png"/>'
      }</div><div>
      ${
        style === ""
  ...
  function UpdateToDoItems(e) {
    if (
      ...
      addUpdate.setAttribute("src", "https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-refresh-512.png");
      todoValue.focus();
    }
  }
  ...
  function UpdateOnSelectionItems() {
    ...
    addUpdate.setAttribute("src", "/image/add.png");
    todoValue.value = "";
